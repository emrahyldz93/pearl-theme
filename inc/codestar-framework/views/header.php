...
<div class="csf-welcome csf-welcome-wrap">
  ...
  <p class="csf-demo-button"><a href="<?php echo esc_url( add_query_arg( array( 'csf-demo' => $status ) ) ); ?>" class="button button-primary<?php echo esc_html( $class ); ?>"><?php echo esc_html( $text ); ?> Demo</a></p>
